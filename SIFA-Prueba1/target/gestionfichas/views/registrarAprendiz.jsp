                  ...
                  <div class="card form">
                      <div class="card-body">
                        <form class="container-fluid " action="aprendiz" method="POST">
                          ...
                          <input class="form-control" type="text" placeholder="Nombre"  name="nombreAprendiz" id="nombreAprendiz" >
                          <p></p>
                          ...
                          <input class="form-control" type="number" placeholder="Documento" name="documentoAprendiz" id="documentoAprendiz"  >
                          <p></p>
                          
                          <input class="form-control" type="number" placeholder="Celular" name="celularAprendiz" id="celularAprendiz" >
                          <p></p>
                            
                          <input class="form-control" type="Correo" placeholder="Correo" name="correoAprendiz" id="correoAprendiz">
                          <p></p>

                          <input class="form-control" type="date" placeholder="Fecha Nacimiento" name="fechaNacimientoAprendiz" id="fechaNacimientoAprendiz">
                          <p></p>
                          ...
                          <input class="form-control" type="text" placeholder="Observaciones" name="observaciones" id="observaciones">
                          <p></p>
