                  ...
                  <div class="card form">
                      <div class="card-body">
                          <form class="container-fluid needs-validation" action="aprendiz" method="POST" novalidate>
                            ...
                            <input class="form-control" type="text" placeholder="Nombre"  name="nombreAprendiz" id="nombreAprendiz" value="${aprendiz.nombreAprendiz}" required>
                            <div class="valid-feedback">
                  
                            </div>
            
                            <div class="invalid-feedback">
                                <h6>Es necesario un número de ficha</h6>
                            </div>
                            <p></p>

                            <select class="form-select" aria-label="Tipo Documento" name="tipodocAprendiz" id="tipodocAprendiz" value="${aprendiz.tipodocAprendiz}" required>
                            ...
                            <input class="form-control" type="number" placeholder="Documento" name="documentoAprendiz" id="documentoAprendiz" value="${aprendiz.documentoAprendiz}" required>
                            <div class="valid-feedback">
                            ...
                            <input class="form-control" type="number" placeholder="Celular" name="celularAprendiz" id="celularAprendiz" value="${aprendiz.celularAprendiz}" required>
                            <div class="valid-feedback">
                            ...
                            <input class="form-control" type="Correo" placeholder="Correo" name="correoAprendiz" id="correoAprendiz" value="${aprendiz.correoAprendiz}" required>
                            <div class="valid-feedback">
                  
                            </div>
            
                            <div class="invalid-feedback">
                                <h6>Es necesario un correo electronico</h6>
                            </div>
                            <p></p>

                            <input class="form-control" type="date" placeholder="Fecha Nacimiento" name="fechaNacimientoAprendiz" id="fechaNacimientoAprendiz" value="${aprendiz.fechaNacimientoAprendiz}" required>
                            <div class="valid-feedback">
                  
                            </div>
            
                            <div class="invalid-feedback">
                                <h6>Es necesario la fecha de nacimiento</h6>
                            </div>
                            <p></p>
