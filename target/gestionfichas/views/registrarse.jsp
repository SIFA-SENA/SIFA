        ...
        <div class="card-body">
            ...
            <form action="usuario" method="POST" class="container-fluid needs-validation" novalidate>
               ...
               <hr>
                ...
                <div class="invalid-feedback">
                  <h6>Es necesario un número de documento</h6>
                </div>
                ...
                <div class="invalid-feedback">
                    <h6>Es necesario un número de celular valido</h6>
                </div>
                ...
                <div class="invalid-feedback">
                  <h6>Este es un usuario invalido</h6>
                </div>
                ...
                <div class="invalid-feedback">
                    <h6>Es necesario un correo electronico valido</h6>
                </div>
                ...
                <div class="invalid-feedback">
                  <h6>Esta contraseña es invalida, como sugerencia que contenga caracteres como Mayusculas, Números y Caracteres especiales como, # * </h6>
                </div>
