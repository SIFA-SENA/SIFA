    ...
    <div class="card ">
        ...
        <div class="card-body">
            ...
            <form action="usuario" method="POST" class="container-fluid " >
                ...
                <input type="text" class="form-control input" placeholder="Nombre Usuario" name="nombreUsuario" id="nombreUsuario" value="${usuario.nombreUsuario}"></input>
                ...
                <input type="number" class="form-control input " placeholder="Numeró de documento" name="documentoUsuario" id="documentoUsuario" value="${usuario.documentoUsuario}"></input>
                
                <p></p>
    
                <input type="number" class="form-control input" placeholder="Celular Usuario" name="celularUsuario" id="celularUsuario" value="${usuario.celularUsuario}"></input>
                
                <p></p>
    
                <input type="text" class="form-control input" placeholder="Rol" name="rol" id="rol" value="${usuario.rol}" ></input>
                <p></p>
    
                <p></p>
                <input type="text" class="form-control input" placeholder="Usuario" name="usuario" id="usuario" value="${usuario.usuario}"></input>
    
                <p></p>
    
                <p></p>
    
                <input type="email" class="form-control input" placeholder="Correo" name="correo" id="correo" value="${usuario.correo}"></input>
                
    
                <p></p>
                
                <input type="password" class="form-control input" placeholder="Contraseña" name="clave" id="clave" value="${clave}"></input>
    
                
                <p></p>
                <input type="submit" class="btn btn-primary boton" name="accion" value="actualizar"></input>
