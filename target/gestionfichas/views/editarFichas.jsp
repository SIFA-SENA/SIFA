          ...
          <div class="col-sm">
            <div class="col-sm" >
              <div class="col-sm ficha1">
                  <div class="card form">
                      <div class="card-body">
                          <form class="container-fluid needs-validation" action="ficha" method="post" novalidate >
                            
                            <input class="form-control" type="number" placeholder="Número ficha" name="idFicha" id="idFIcha" value="${ficha.idFicha}" required>
                            ...
                            <input class="form-control" type="text" placeholder="Programa Formación" name="programaFormacion" id="programaFormacion" value="${ficha.programaFormacion}" required>
                            <div class="valid-feedback">
                  
                            </div>
            
                            <div class="invalid-feedback">
                                <h6>Es necesario un programa de formación</h6>
                            </div>
                            <p></p>
  
                            <select class="form-select" aria-label="Area de formación" name="areaFormacion" id="areaFormacion" value="${ficha.areaFormacion}" required>
                            ...
                            <select class="form-select" aria-label="Lugar de formación" name="lugarFormacion" id="lugarFormacion" value="${ficha.lugarFormacion}" required>
                            ...
                            <select class="form-select" aria-label="Estado Ficha" name="estadoFicha" id="estadoFicha" value="${ficha.estadoFicha}" required>
