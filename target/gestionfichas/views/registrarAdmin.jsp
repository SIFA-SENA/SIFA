                  ...
                  <div class="card form">
                      <div class="card-body">
                        <form action="usuario" method="POST" class="container-fluid needs-validation" novalidate>
                          ...
                          <input type="text" class="form-control input" placeholder="Nombre Usuario" name="nombreUsuario" id="nombreUsuario" required></input>
                          
                        <div class="valid-feedback">
                            
                        </div>
                        <div class="invalid-feedback">
                          <h6>Por favor ingrese el nombre</h6>
                        </div>
                          <p></p>
                          ...
                          <div class="invalid-feedback">
                            <h6>Por favor ingrese el tipo de documento</h6>
                          </div>

          
                          <p></p>
              
                          <input type="number" class="form-control input " placeholder="Numeró de documento" name="documentoUsuario" id="documentoUsuario"required ></input>
                          <div class="valid-feedback">
                            
                          </div>
                          <div class="invalid-feedback">
                            <h6>Por favor ingrese el documento</h6>
                          </div>

                          <p></p>
              
                          <input type="number" class="form-control input" placeholder="Celular Usuario" name="celularUsuario" id="celularUsuario" required></input>
                          <div class="valid-feedback">
                            
                          </div>
                          <div class="invalid-feedback">
                            <h6>Por favor ingrese el número de celular</h6>
                          </div>
                          <p></p>
              
                          <select class="form-select form-select-lg mb-3 " aria-label="Large select example" name="rol" id="rol" required>
                          ...
                          <p></p>
                          <input type="text" class="form-control input" placeholder="Usuario" name="usuario" id="usuario" required ></input>
                          <div class="valid-feedback">
                            
                          </div>
                          <div class="invalid-feedback">
                            <h6>Por favor ingrese el usuario</h6>
                          </div>
                          <p></p>
              
                          <p></p>
              
                          <input type="email" class="form-control input" placeholder="Correo" name="correo" id="correo" required></input>
                          <div class="valid-feedback">
                            
                          </div>
                          <div class="invalid-feedback">
                            <h6>Por favor ingrese un correo electronico valido</h6>
                          </div>
              
                          <p></p>
                          
                          <input type="password" class="form-control input" placeholder="Contraseña" name="clave" id="clave" required></input>
                          <div class="invalid-feedback">
                            <h6>Esta contraseña es invalida, como sugerencia revisa que contenga caracteres como Mayusculas, Números y Caracteres especiales como, # * </h6>
                          </div>
