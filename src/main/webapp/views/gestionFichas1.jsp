...
<body>
    ...
    <div class="row" >
        ...
        <div class="col-sm-2 dashboard o">
          <div class="col-sm b  ">
              <strong><h3>Instructor</h3></strong>
          </div>
          <hr>
          ...
          <div class="accordion" id="accordionExample">
              ...
              <div class="accordion-item aco">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                      <div class="accordion-body">
                          <li class="li"><a href="ficha?accion=abrirFormI" class="as">Registrar Ficha</a></li>
                          <li class="li"><a href="ficha?accion=listarI" class="as">Consultar Fichas</a></li>    
                      </div>
                  </div>
                </div>
              </div>
              <div class="accordion-item aco">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                      <li class="li"><a href="aprendiz?accion=FormRegistrarAI" class="as">Registrar Aprendiz</a></li>  
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm">
            <div class="col-sm" >
              <div class="col-sm ficha1">
                  <div class="card form">
                      <div class="card-body">
                        <form class="container-fluid needs-validation" action="ficha" method="post" validate>
                            
                          <input class="form-control" type="number" placeholder="Número ficha" name="idFicha" id="idFIcha" required>
                          ...
                          <div class="invalid-feedback">
                              <h6>Digite el número de Ficha</h6>
                          </div>

                          <p></p>

                          <input class="form-control" type="text" placeholder="Programa Formación" name="programaFormacion" id="programaFormacion" required>
                          ...
                          <div class="invalid-feedback">
                              <h6>Digite el nombre del programa de la Ficha</h6>
                          </div>

                          <p></p>

                          <select class="form-select" aria-label="Area de formación" name="areaFormacion" id="areaFormacion" required>
                          ...
                          <select class="form-select" aria-label="Lugar de formación" name="lugarFormacion" id="lugarFormacion" required>
                          ...
                          <select class="form-select" aria-label="Estado Ficha" name="estadoFicha" id="estadoFicha" required>
