                  ...
                  <div class="card form">
                      <div class="card-body">
                        <form class="container-fluid needs-validation" action="aprendiz" method="POST" novalidate>
                          ...
                          <select class="form-select" aria-label="Tipo Documento" name="tipodocAprendiz" id="tipodocAprendiz" required>
                          ...
                          <select class="form-select" aria-label="Estado" name="estadoAprendiz" id="estadoAprendiz" required>
                          ...
                          <div class="invalid-feedback">
                            <h6>EEscriba las observaciones sobre el apreniz, en caso de que no cuente con una escriba "No"</h6>
                          </div>
                          <p></p>

                          <select class="form-select" aria-label="Ficha" name="idFichaFK" id="idFichaFK" required>
                    ...
                    <% Integer registroExitoso = (Integer)request.getAttribute("registroExitoso"); %>
                    <% if (registroExitoso != null) { %>
                        <div class="alert <%= registroExitoso == 1 ? "alert-success" : "alert-danger" %>">
